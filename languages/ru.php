...
$plugin_tx['cryptographp']['error_audio']="Аудио капча не генерирована! Пожалуйста, повторите попытку.";
...
$plugin_tx['cryptographp']['cf_bg_clear']="Сделать фон прозрачным";
...
$plugin_tx['cryptographp']['cf_bg_frame']="Добавить рамку вокруг пиктограммы";
...
$plugin_tx['cryptographp']['cf_char_displace']="Случайное смещение символов в вертикальном направлении";
$plugin_tx['cryptographp']['cf_crypt_gaussian_blur']="Размытие символов с использованием метода Гаусса.";
$plugin_tx['cryptographp']['cf_crypt_gray_scale']="Конвертирование изображения в оттенки серого.";
